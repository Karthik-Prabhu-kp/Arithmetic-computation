...
Arithmatic_Array[((count++))]=${Arithmaticoperation[comp1]}
Arithmatic_Array[((count++))]=${Arithmaticoperation[comp2]}
Arithmatic_Array[((count++))]=${Arithmaticoperation[comp3]}
Arithmatic_Array[((count++))]=${Arithmaticoperation[comp4]}
